...
case class ConfigurationError(msg:String) extends Exception
case class ConnectionConfig(proto:String, user:String, pass:Option[String], private val _hostAndPort: HostAndPort, dbName:String){
